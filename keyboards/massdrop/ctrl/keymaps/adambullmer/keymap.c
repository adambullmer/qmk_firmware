...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     */
    [_QW] = LAYOUT(
        KC_ESC,  KC_MUTE, KC_VOLD, KC_VOLU, _______, KC_MPRV, KC_MPLY, KC_MNXT, _______, _______, _______, _______, KC_PSCR,            KC_MUTE, KC_VOLD, KC_VOLU,
    ...
    //////////////////////////////////////////////////
    [_ML] = LAYOUT(
        KC_EJCT, KC_BRMD, KC_BRMU, _______, _______, _______, KC_SLEP, KC_MPRV, KC_MPLY, KC_MNXT, KC_MUTE, KC_VOLD, KC_VOLU,            _______, _______, _______,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,   _______, _______, _______,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,   _______, _______, _______,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,                              _______,
        _______, KC_LALT, KC_LGUI,                   _______,                            KC_RGUI, _______,  KC_APP, _______,            _______, _______, _______
    ),
    [_UL] = LAYOUT(
        ...
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,                              _______,
        KC_LCTL, KC_LGUI, KC_LALT,                   KC_SPC,                             KC_RALT, _______, KC_APP,  KC_RCTL,            _______, _______, _______
    ),
    //////////////////////////////////////////////////
    [_GL] = LAYOUT(
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,            _______, _______, _______,
    ...
    [_FN] = LAYOUT(
        ...
        _______, DF(_QW), DF(_DV), DF(_CM), TO(_ML), TO(_UL), TO(_GL), TO(_VL), _______, _______, _______, _______, _______, _______,   KC_MPLY, KC_MSTP, KC_VOLU,
        L_T_BR,  L_PSD,   L_BRI,   L_PSI,   L_EDG_I, _______, TG(_D1), FG(_D2), U_T_AGCR,_______, _______, _______, _______, _______,   KC_MPRV, KC_MNXT, KC_VOLD,
