...
led_instruction_t led_instructions[] = {
    ...
    //  { .flags = LED_FLAG_MATCH_LAYER | LED_FLAG_USE_ROTATE_PATTERN, .layer = _UL },
     ...
     { .flags = LED_FLAG_MATCH_LAYER | LED_FLAG_MATCH_ID | LED_FLAG_USE_RGB, .layer = _ML, LED_IDS_ACCENT,            ELVISH_S_EVANSTAR },
     { .flags = LED_FLAG_MATCH_LAYER | LED_FLAG_MATCH_ID | LED_FLAG_USE_RGB, .layer = _ML, LED_IDS_BORDER_ACCENT,     ELVISH_S_EVANSTAR },
     ...
     { .flags = LED_FLAG_MATCH_LAYER | LED_FLAG_MATCH_ID | LED_FLAG_USE_RGB, .layer = _UL, LED_IDS_ACCENT,            BLACK_SPEECH_S_MAGMA },
     { .flags = LED_FLAG_MATCH_LAYER | LED_FLAG_MATCH_ID | LED_FLAG_USE_RGB, .layer = _UL, LED_IDS_BORDER_ACCENT,     BLACK_SPEECH_S_MAGMA },
