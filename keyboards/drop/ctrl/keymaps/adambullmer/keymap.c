...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    //////////////////////////////////////////////////
    [_GL] = LAYOUT_wrapper(
        TG(_GL), _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,            _______, _______, _______,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,   _______, _______, _______,
        _______, _______, G_REMTE, G_RESET, G_REBAS, G_TREE,  _______, _______, G_INIT,  _______, _______, G_PULL,  G_PUSH,  _______,   _______, _______, _______,
        _______, G_ADD,   G_STAT,  G_DIFF,  G_FIXUP, G_FETCH, _______, _______, _______, G_LOG,   _______, _______, _______,
        _______, _______, G_CHECK, G_CLONE, G_COMM,  G_BRANH, G_NBRAN, G_MERGE, G_CONF,  _______, _______, _______,                              _______,
