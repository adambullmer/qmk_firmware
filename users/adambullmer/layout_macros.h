...
#define LAYOUT_TKL_WINDOWS_FUNCTION   KC_MUTE, KC_VOLD, KC_VOLU, _______, KC_MPRV, KC_MPLY, KC_MNXT, _______, _______, L_BRD,   L_BRI,   KC_PSCR
#define LAYOUT_TKL_MAC_FUNCTION       KC_BRMD, KC_BRMU, XXXXXXX, XXXXXXX, L_BRD,   L_BRI,   KC_MPRV, KC_MPLY, KC_MNXT, KC_MUTE, KC_VOLD, KC_VOLU
#define LAYOUT_TKL_UBUNTU_FUNCTION    KC_MUTE, KC_VOLD, KC_VOLU, _______, KC_MPRV, KC_MPLY, KC_MNXT, _______, _______, L_BRD,   L_BRI,   KC_PSCR
