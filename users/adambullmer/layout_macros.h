...
// #define LAYOUT_TKL_COLMAK_R3 KC_A,    KC_R,    KC_S,    KC_T,    KC_D,    KC_H,    KC_N,    KC_E,    KC_L,    KC_O,    KC_QUOT
// #define LAYOUT_TKL_COLMAK_R4 KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_K,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH

// Phase 3
// #define LAYOUT_TKL_COLMAK_R2 KC_Q,    KC_W,    KC_F,    KC_J,    KC_G,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_LBRC, KC_RBRC
// #define LAYOUT_TKL_COLMAK_R3 KC_A,    KC_R,    KC_S,    KC_T,    KC_D,    KC_H,    KC_N,    KC_E,    KC_L,    KC_SCLN, KC_QUOT
// #define LAYOUT_TKL_COLMAK_R4 KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_K,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH

// Phase 2
// #define LAYOUT_TKL_COLMAK_R2 KC_Q,    KC_W,    KC_F,    KC_R,    KC_G,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_LBRC, KC_RBRC
// #define LAYOUT_TKL_COLMAK_R3 KC_A,    KC_S,    KC_D,    KC_T,    KC_J,    KC_H,    KC_N,    KC_E,    KC_L,    KC_SCLN, KC_QUOT
// #define LAYOUT_TKL_COLMAK_R4 KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_K,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH
